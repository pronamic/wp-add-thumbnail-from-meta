...
Tags: thumbnail, image, download, url
Donate link: http://pronamic.eu/donate/?for=wp-add-thumbnail-from-meta&source=wp-plugin-readme-txt
Requires at least: 3.0
Tested up to: 3.4.1
Stable tag: 0.1

WordPress plugin wich will add an thumbnail to an WordPress post from an post meta value.
